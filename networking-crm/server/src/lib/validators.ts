...
export const createContactSchema = z.object({
  ...
  met_country: z.string().max(5).optional(),
  origin_country: z.string().max(5).optional(),
...
export const updateContactSchema = z.object({
  ...
  met_country: z.string().max(5).nullable().optional(),
  origin_country: z.string().max(5).nullable().optional(),
