...
async function handleHelp(ctx: Context) {
  const text = [
    "<b>справка</b>",
    "",
    "<b>голосовые и текст</b>",
    "отправь голосовое, кружочек или аудио.",
    "или просто напиши текстом о человеке.",
    "распознаю и создам контакт.",
    "",
    "<b>быстрый поиск</b>",
